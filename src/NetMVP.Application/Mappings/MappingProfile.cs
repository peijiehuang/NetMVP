...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<SysUser, UserDto>()
            ...
            .ForMember(dest => dest.Sex, opt => opt.MapFrom(src => EnumHelper.ToGenderString(src.Gender)))
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => EnumHelper.ToStatusString(src.Status)))
            .ForMember(dest => dest.Dept, opt => opt.Ignore());

        // 角色映射
        CreateMap<SysRole, RoleDto>()
            .ForMember(dest => dest.DataScope, opt => opt.MapFrom(src => ((int)src.DataScope).ToString()))
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => EnumHelper.ToStatusString(src.Status)))
        ...
        CreateMap<SysMenu, MenuDto>()
            .ForMember(dest => dest.MenuType, opt => opt.MapFrom(src => 
                src.MenuType == MenuType.Directory ? "M" : 
                src.MenuType == MenuType.Menu ? "C" : "F"))
            .ForMember(dest => dest.Visible, opt => opt.MapFrom(src => ((int)src.Visible).ToString()))
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => EnumHelper.ToStatusString(src.Status)))
        ...
        CreateMap<SysDictData, DictDataDto>()
            .ForMember(dest => dest.IsDefault, opt => opt.MapFrom(src => ((int)src.IsDefault).ToString()))
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => EnumHelper.ToStatusString(src.Status)));
        ...
        CreateMap<SysNotice, NoticeDto>()
            .ForMember(dest => dest.NoticeType, opt => opt.MapFrom(src => ((int)src.NoticeType).ToString()))
            .ForMember(dest => dest.Status, opt => opt.MapFrom(src => EnumHelper.ToNoticeStatusString(src.Status)))
